...
function show_distribution_summary(report) {
    ...
    frappe.call({
        method: "symayal2.sysmayal2.report.distribution_analytics_report.distribution_analytics_report.get_distribution_summary",
...
function show_performance_metrics(report) {
    ...
    frappe.call({
        method: "symayal2.sysmayal2.report.distribution_analytics_report.distribution_analytics_report.get_performance_metrics",
        args: { filters: filters },
        callback: function(r) {
            if (r.message) {
...
function show_contact_analytics(report) {
    ...
    frappe.call({
        method: "symayal2.sysmayal2.report.distribution_analytics_report.distribution_analytics_report.get_contact_analytics",
        args: { filters: filters },
        callback: function(r) {
            if (r.message) {
