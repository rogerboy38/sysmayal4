...
function send_compliance_alerts(report) {
    ...
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: "sysmayal.sysmayal_module_module.report.compliance_status_report.compliance_status_report.send_compliance_alerts",
                args: {
...
function bulk_update_compliance_status(report) {
    ...
    const dialog = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            ...
            frappe.call({
                method: "sysmayal.sysmayal_module_module.doctype.product_compliance.product_compliance.bulk_update_compliance_status",
                args: {
