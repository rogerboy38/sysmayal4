...
function show_portfolio_summary(report) {
    ...
    frappe.call({
        method: "symayal2.sysmayal_module.report.rd_project_status_report.rd_project_status_report.get_project_portfolio_summary",
...
function show_performance_metrics(report) {
    ...
    frappe.call({
        method: "symayal2.sysmayal_module.report.rd_project_status_report.rd_project_status_report.get_project_performance_metrics",
        args: { filters: filters },
        callback: function(r) {
            if (r.message) {
...
function show_risk_analysis(report) {
    ...
    frappe.call({
        method: "symayal2.sysmayal_module.report.rd_project_status_report.rd_project_status_report.get_project_risks_and_issues",
        args: { filters: filters },
        callback: function(r) {
            if (r.message) {
