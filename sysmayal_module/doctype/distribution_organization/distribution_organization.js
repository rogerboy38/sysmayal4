...
function check_duplicate_organization(frm) {
    frappe.call({
        method: 'symayal2.sysmayal2.doctype.distribution_organization.distribution_organization.check_duplicate_organization',
        args: {
...
function show_organization_hierarchy(frm) {
    frappe.call({
        method: 'symayal2.sysmayal2.doctype.distribution_organization.distribution_organization.get_organization_hierarchy',
        args: {
