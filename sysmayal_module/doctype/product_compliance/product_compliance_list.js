...
function bulk_update_compliance_status(listview) {
    let dialog = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            ...
            frappe.call({
                method: "symayal2.sysmayal_module.doctype.product_compliance.product_compliance.bulk_update_compliance_status",
                args: {
                    filters: filters,
...
function export_compliance_data(listview) {
    ...
    frappe.call({
        method: "symayal2.sysmayal_module.doctype.product_compliance.product_compliance.export_compliance_data",
        args: {
            filters: filters
        },
        callback: function(r) {
...
function show_expiry_alerts(listview) {
    frappe.call({
        method: "symayal2.sysmayal_module.doctype.product_compliance.product_compliance.get_expiry_alerts",
        callback: function(r) {
            if (r.message) {
