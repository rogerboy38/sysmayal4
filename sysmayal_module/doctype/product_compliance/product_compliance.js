...
function setup_compliance_tracking(frm) {
    ...
    if (frm.doc.country && frm.doc.product_name) {
        frappe.call({
            method: "symayal2.sysmayal2.doctype.product_compliance.product_compliance.get_compliance_requirements",
            args: {
                country: frm.doc.country,
...
function generate_compliance_certificate(frm) {
    frappe.call({
        method: "symayal2.sysmayal2.doctype.product_compliance.product_compliance.generate_compliance_certificate",
        args: {
...
function renew_compliance(frm) {
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: "symayal2.sysmayal2.doctype.product_compliance.product_compliance.renew_compliance",
                args: {
                    "compliance_name": frm.doc.name
                },
                callback: function(r) {
...
function request_product_testing(frm) {
    let dialog = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            frappe.call({
                method: "symayal2.sysmayal2.doctype.product_compliance.product_compliance.request_testing",
                args: {
                    "compliance_name": frm.doc.name,
                    "test_details": values
                },
