...
function add_custom_buttons(frm) {
    if (!frm.doc.__islocal) {
        ...
        frm.add_custom_button(__('Market Intelligence'), function() {
            frappe.call({
                method: "symayal2.sysmayal2.doctype.market_research.market_research.get_market_intelligence_by_country",
...
function generate_market_research_report(frm) {
    frappe.call({
        method: "symayal2.sysmayal2.doctype.market_research.market_research.generate_market_report",
...
function show_competitive_analysis(frm) {
    frappe.call({
        method: "symayal2.sysmayal2.doctype.market_research.market_research.get_competitive_analysis_summary",
        args: {"research_name": frm.doc.name},
        callback: function(r) {
            if (r.message) {
...
function share_research_findings(frm) {
    let dialog = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            frappe.call({
                method: "symayal2.sysmayal2.doctype.market_research.market_research.share_research",
                args: {
