...
frappe.listview_settings['Distribution Organization'] = {
    ...
    onload: function(listview) {
        ...
        listview.page.add_menu_item(__("Bulk Import"), function() {
            frappe.call({
                method: "sysmayal.sysmayal_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module_module.data_import.bulk_importer.get_import_template",
...
function export_organizations_data(listview) {
    ...
    frappe.call({
        method: "sysmayal.sysmayal_module_module.data_import.bulk_importer.export_organizations",
        args: {
            "filters": filters
        },
        callback: function(r) {
